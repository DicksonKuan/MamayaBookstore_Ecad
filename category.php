...
while($row = $result->fetch_array()){
    echo "<div class='row' style='padding: 5px'>"; //Strt a new row

    //Left column - Display a text link showingn the category name,
    //              Display category's desccription in a new paragraph 
